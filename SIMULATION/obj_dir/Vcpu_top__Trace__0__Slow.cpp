...
VL_ATTR_COLD void Vcpu_top___024root__trace_init_sub__TOP__0(Vcpu_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+7,0,"instr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+8,0,"pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+1,0,"alu_op",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+3,0,"data_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+10,0,"we",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
...
VL_ATTR_COLD void Vcpu_top___024root__trace_full_0_sub_0(Vcpu_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelf->cpu_top__DOT__alu_op),4);
    bufp->fullIData(oldp+2,(vlSelf->cpu_top__DOT__alu_result),32);
    bufp->fullIData(oldp+3,(vlSelf->cpu_top__DOT__data_out),32);
    bufp->fullIData(oldp+4,(vlSelf->cpu_top__DOT__dm__DOT__unnamedblk1__DOT__i),32);
